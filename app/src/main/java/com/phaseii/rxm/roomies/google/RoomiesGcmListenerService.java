...
*/
/**
 * Created by Snehankur on 6/26/2015.
 *
 ...
 *
 * In some cases it may be useful to show a notification indicating to the user that a message was
 * received.
 *
...
public class RoomiesGcmListenerService extends GcmListenerService {
...
, intent,
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.roomies_launcher)
