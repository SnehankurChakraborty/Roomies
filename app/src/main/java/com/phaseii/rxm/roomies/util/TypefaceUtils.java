...
public class TypefaceUtils {
    ...
    public Typeface getFont(int font) {
        switch (font) {
            ...
            case LATO_BLACK: return latoBlack;
            case LATO_BOLD: return latoBold;
            case LATO_HAIRLINE: return latoHairline;
            case LATO_HEAVY: return latoHeavy;
            case LATO_MEDIUM: return latoMedium;
            case LATO_REGULAR: return latoRegular;
            case LATO_SEMIBOLD: return latoSemiBold;
            case LATO_THIN: return latoThin;
            case LILYSCRIPTONE: return lilyScriptOne;
            case VARELAROUND: return varelaRound;
