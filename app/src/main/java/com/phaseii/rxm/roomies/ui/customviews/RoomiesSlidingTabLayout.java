 ...
 */
public class RoomiesSlidingTabLayout extends HorizontalScrollView {
    ...
    public RoomiesSlidingTabLayout(Context context) {
        this(context, null);
    }

    public RoomiesSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoomiesSlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new RoomiesSlidingTabStrip(context);
        addView(mTabStrip, LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
    }

    /**
     * Set the custom {@link TabColorizer} to be used. <p/> If you only require simple custmisation
     * then you can use {@link #setSelectedIndicatorColors(int...)} to achieve similar effects.
     */
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link RoomiesSlidingTabLayout}
     * you are required to set any {@link ViewPager.OnPageChangeListener} through this method. This
     * is so that the layout can update it's scroll position correctly.
     *
