...
public class UserDetailsProvider extends ContentProvider {
	...
	static {
		...
		uriMatcher.addURI(AUTHORITY, "userdetails/room/*", SPECIFIC_ROOM_DETAILS);
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
		...
		switch (uriMatcher.match(uri)) {
			...
			case SPECIFIC_ROOM_DETAILS:
				qb.appendWhere(UserDetails.USER_ROOM_ID + "=" + uri.getLastPathSegment());
				break;
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		switch (uriMatcher.match(uri)) {
			...
			case SPECIFIC_ROOM_DETAILS:
				...
				selection = selection + UserDetails.USER_ROOM_ID + " = ?";
