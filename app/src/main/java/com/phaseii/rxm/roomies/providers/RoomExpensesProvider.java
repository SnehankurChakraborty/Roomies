 ...
 * @since 6/28/2015
 * <h3>{@link com.phaseii.rxm.roomies.database.RoomiesContract.RoomExpenses room_expense}</h3>
 * <ul>
 * <li>_id                  integer autoincrement</li>
 * <li>room_id              integer</li>
 * <li>user_id              integer</li>
 * <li>expense_category     text</li>
 * <li>expense_subcategory  text</li>
 * <li>expense_desc         text</li>
 * <li>expense_amount       integer</li>
 * <li>expense_quantity     integer</li>
 * <li>expense_date         date</li>
 * </ul><br/>
 * <b>ALL DETAILS URL</b> = <u style='color:blue'>content://com.phaseii.rxm.roomies.providers
 * .RoomExpensesProvider/roomexpenses</u><br/>
 * <br/>
 * <b>SPECIFIC ROOM URL</b> = <u style='color:blue'>content://com.phaseii.rxm.roomies.providers
 * .RoomExpensesProvider/roomexpenses/room/room_id</u><br/>
 * <br/>
 * <b>SPECIFIC MONTH URL</b> = <u style='color:blue'>content://com.phaseii.rxm.roomies.providers
 * .RoomExpensesProvider/roomexpenses/month/july15</u><br/>
 * <br/>
 * <b>SPECIFIC USER URL</b> = <u style='color:blue'>content://com.phaseii.rxm.roomies.providers
 * .RoomExpensesProvider/roomexpenses/user/user_id</u><br/>
 */
public class RoomExpensesProvider extends ContentProvider {

    public static final String AUTHORITY = "com.phaseii.rxm.roomies.providers.RoomExpensesProvider";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        count = db.delete(RoomExpenses.EXPENSE_TABLE_NAME, selection,
                selectionArgs);
        return count;
    }
